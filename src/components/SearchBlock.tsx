import { parseSearchPath, searchObj } from '@/pages/Search';
...
export default function SearchBlock({ collapse = false }: searchBlockParams) {
  ...
  return (
    <div className=" flex flex-col gap-6 px-7 pt-6 p-3 ">
      <div className="flex flex-col bg-card border border-card-line shadow-2xs rounded-xl">
        ...
        <div id="hs-search" className="hidden hs-collapse overflow-hidden transition-all duration-300" aria-labelledby="hs-search-collapse" role="region">
          ...
          <div className="p-4  ">
            <form onSubmit={(e) => {
              ...
              <div className="relative">
                <input
                  id="name-input"
                  className=" peer p-4 block w-full bg-layer border-layer-line rounded-lg text-md text-foreground placeholder:text-transparent focus:border-primary-focus focus:ring-primary-focus disabled:opacity-50 disabled:pointer-events-none focus:pt-6 focus:pb-2 not-placeholder-shown:pt-6 not-placeholder-shown:pb-2 autofill:pt-6 autofill:pb-2 "
                  placeholder="name"
                  value={queryName}
